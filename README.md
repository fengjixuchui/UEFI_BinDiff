...
3. [Usage](#usage)
    - [idb and i64 files generation](#usage-1)
    - [Analysing release versions of UEFI images with BinDiff IDA plugin](#usage-2)
...
* you can import symbols and comments in `Matched Functions` window
    ...
    ![matched-functions](https://raw.githubusercontent.com/yeggor/UEFI_BinDiff/img/matched-functions.png)

* also you can compare the flow of execution for each function

    ![flow-graph](https://raw.githubusercontent.com/yeggor/UEFI_BinDiff/img/flow-graph.png)
